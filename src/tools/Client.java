...
public class Client implements GamesConstants {
    ...
    public Client(Stage primaryStage) {
        ...
        lblTitle.setFont(Font.font("Times New Roman", FontWeight.BOLD, FontPosture.ITALIC, 20));
        lblStatus.setFont(Font.font("Times New Roman", FontWeight.BOLD, FontPosture.ITALIC, 20));
